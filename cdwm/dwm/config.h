...
// static const char *voldown[] = { "~/scripts/volume_decrease.sh",  NULL };
// static const char *volup[]   = { "~/scripts/volume_increase.sh",  NULL };

static const char *upvol[] = {"/home/chris/scripts/volume_increase.sh", NULL};
static const char *downvol[] = {"/home/chris/scripts/volume_decrease.sh", NULL};
static const char *mutevol[] = {"/home/chris/scripts/volume_toggle.sh", NULL};
...
static const char *setcolemakcmd[] = {
    "/home/david/scripts/setxmodmap-colemak.sh", NULL};
static const char *setqwertycmd[] = {"/home/david/scripts/setxmodmap-qwerty.sh",
                                     NULL};
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_b, spawn, {.v = codecmd}},
    ...
    {0, 0xffc1, spawn, {.v = mutevol}},
    // { 0,			             XK_F2,	                  spawn,
    // SHCMD("pamixer
    // --allow-boost -d 5") }, { 0,			             XK_F3,
    // spawn,		      SHCMD("pamixer --allow-boost -i 5") }, { 0,
    // XK_F4,	                  spawn,		      SHCMD("pamixer
    // --allow-boost -t")
    // }, { MODKEY,              XK_bracketleft,          spawn,          {.v =
    // downvol } }, { MODKEY,              XK_backslash,            spawn, {.v =
    // mutevol } }, { MODKEY,              XK_bracketright,         spawn, {.v =
    // upvol   } },
    {MODKEY, XK_b, spawn, {.v = wpcmd}},
    {0, 0xffbe, spawn, {.v = screenshotcmd}},
